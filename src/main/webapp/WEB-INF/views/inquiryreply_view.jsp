...
<h3>답글달기</h3>
	<form action="InquiryReply" method="post">
		<input type="hidden" name="daid" value="${inquiryreply_view.daid }" />
		<input type="hidden" name="dagroup" value="${inquiryreply_view.dagroup }" />
		<input type="hidden" name="dastep" value="${inquiryreply_view.dastep }" />
		<input type="hidden" name="daindent" value="${inquiryreply_view.daindent }" />
<table>
		<tr>
			<td class="left">번호</td>
			<td>${inquiryreply_view.daid }</td>
		</tr>
	
		<tr>
			<td class="left">제목</td>
			<td>
				<input type="text" name="datitle" value="${inquiryreply_view.datitle }" />
			</td>
		</tr>
		<tr>
			<td class="left">글쓴이</td>
			<td>
				<input type="text" name="daname" value="${membernick}" readonly="${membernick }" />
			</td>
		</tr>
		...
		<tr>
			<td class="left">내용</td>
			<td>
			<textarea name="dacontent"  cols="30" rows="10">
			${inquiryreply_view.dacontent }</textarea>
			
			</td>
		</tr>
		<tr>
			<td colspan="2">
				<input type="submit" class="btn_s" value="답글달기" /> 
