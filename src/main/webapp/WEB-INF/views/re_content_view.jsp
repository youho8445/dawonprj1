...
<h3>re_content_view.jsp</h3>
<table>
	<form action="modify" method="post">
		<input type="hidden" name="reid" value="${re_content_view.reid }" />
		<tr>
			<td class="left">번호</td>
			<td>${re_content_view.reid }</td>
		</tr>
		<tr>
			<td class="left">제목</td>
			<td>
		...
		<tr>
			...
			<td>
			<textarea name="recontent"  cols="30" rows="10">${re_content_view.recontent }
			</textarea>
		...
		<tr>
			<td colspan="2">
				...
				<a href="re_reply_view?reid=${re_content_view.reid }">답변</a> &nbsp;&nbsp;
			</td>	
		</tr>
	</form>
</table>
