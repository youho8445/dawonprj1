...
<table>
	<form action="Inquirywrite" method="post">
		<tr>
			<td class="left">제목</td>
			<td>
				<input type="text" name="datitle" size="30" />
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td class="left">내용</td>
			<td>
				<textarea name="dacontent"  cols="30" rows="10"></textarea>
			</td>
		</tr>
		<tr>
			<td colspan="2">
				<input type="submit" id="btn_s" value="작성하기" /> 
				<input type="button" id="btn_s" onclick="location.href='inquiry'" value="목록보기" />
