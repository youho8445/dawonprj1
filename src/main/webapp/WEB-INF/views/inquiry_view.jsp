...
<h3>문의사항</h3>
	<form action="inquiry_view2" method="post">
...
<table>
		...
		<tr>
			<td class="left">제목</td>
			<td>
				<input type="text" name="datitle" readonly="${inquiry_view.datitle }" value="${inquiry_view.datitle }" />
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td class="left">내용</td>
			<td>
			<input type="text"  id="dacontent" name="dacontent"readonly="${inquiry_view.dacontent }" style="width: 300px; height:100px; " value="${inquiry_view.dacontent }"  />
		</tr>
		<tr>
			<td colspan="2">
				<input type="submit" class="btn_s" id="submit" value="수정하기" />
				<input type="button" class="btn_s" onclick="location.href='inquiry'" value="목록보기" />
				<input type="button" class="btn_s" onclick="location.href='inquiryreply_view?daid=${inquiry_view.daid }'" value="답글달기" />
