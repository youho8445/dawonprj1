...
<body>
	...
	<h1>${membernick }님의미니홈피</h1>
	<h2>쪽지 보내기</h2>
	<form action="replysend" method="post">
	<input type="hidden" id="nonum" name="nonum" value="${reply.nonum }" />
		<table class="loginc" border="3">
			...
			<tr>
				<td>받는사람</td>
				<td><input type="text" style="width: 400px; height: 50px;" name="takenick" value="${reply.sendnick}" readonly="${reply.sendnick}"   /></td>
			</tr>
			<tr>
				<td>제목</td>
		...
		<button type="submit" id="btn_s" style="width: 70px; height: 25px">전송</button>
		<button type="button" id="btn_s"><a href="minihompy?memberid=${memberid }">취소</a></button>
	</form>
