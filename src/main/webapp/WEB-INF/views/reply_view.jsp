...
<h3>답글달기</h3>
	<form action="reply" method="post">
		<input type="hidden" name="daid" value="${reply_view.daid }" />
		<input type="hidden" name="dagroup" value="${reply_view.dagroup }" />
		<input type="hidden" name="dastep" value="${reply_view.dastep }" />
		<input type="hidden" name="daindent" value="${reply_view.daindent }" />
<table>

		<tr>
			<td class="left">번호</td>
			<td>${reply_view.daid }</td>
		</tr>
		<tr>
			<td class="left">히트</td>
			<td>${reply_view.dahit }</td>
		</tr>
		<tr>
			<td class="left">제목</td>
			<td>
				<input type="text" name="datitle"  />
			</td>
		</tr>
		<tr>
			<td class="left">글쓴이</td>
			<td>
				<input type="text" name="daname" readonly="${membernick }" value="${membernick}" />
			</td>
		</tr>
