	...
	<div id="wrap">
		...
		<div id="banner">
			<div class="container">
				...
				<ul>
                 <li class="topMenuLi"><a class="menuLink" href="introducepage">소개</a>
                  <ul class="submenu">
                     ...
                     <li><a class="submenuLink longLink" href="#">준비중입니다</a></li>
                  </ul></li>
               <!--    <li>|</li> -->
               <li class="topMenuLi"><a class="menuLink" href="#">이상형만나기</a>
                  <ul class="submenu">
               ...
               <!--    <li>|</li> -->
               <li class="topMenuLi"><a class="menuLink" href="memberprofile?memberid=${memberid }">마이페이지</a>
                  <ul class="submenu">
                     ...
                     <li><a class="submenuLink"
                        ...
                        <li><a class="submenuLink" href="memberpw?memberid=${memberid }">비밀번호 변경</a></li>
                        <li><a class="submenuLink" href="memberdelete?memberid=${memberid }">회원탈퇴</a></li>
                  </ul></li>
...
<h3>수정하기</h3>
	<form action="modify" method="post">
		<input type="hidden" name="daid" value="${content_view.daid }" />
<table>
		<tr>
			<td class="left">번호</td>
			<td>${content_view.daid }</td>
		</tr>
		<tr>
			<td class="left">히트</td>
			<td>${content_view.dahit }</td>
		</tr>
		<tr>
			<td class="left">제목</td>
			<td>
				<input type="text" id="datitle" name="datitle" value="${content_view.datitle }" />
			</td>
		</tr>
		<tr>
			<td class="left">글쓴이</td>
			<td>
				<input id="daname" name="daname" value="${content_view.daname }" readonly="${content_view.daname }" />
			</td>
		</tr>
		...
		<tr>
			<td class="left">내용</td>
			<td>
			<input type="text"  id="dacontent" name="dacontent" style="width: 300px; height:100px; " value="${content_view.dacontent }"  />	
			</td>
		</tr>
		<tr>
			<td colspan="2">
				<input type="submit" class="btn_s" id="submit" value="수정하기" />
				<input type="button" class="btn_s" onclick="location.href='free_board'" value="목록보기" />
				<input type="button" class="btn_s" id="button" onclick="location.href='delete?daid=${content_view.daid }'" value="삭제하기" />
